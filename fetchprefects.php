...
<head>
    ...
    <title>Prefects anf councilors suggestions</title>
    <style type="text/css">
        button{
            font-size: 15px;
            font-weight:bold;
...
<table border="0" cellspacing="0">
                <thead>
                    <caption style="font-weight:bolder; font-size:30px;">PREFECTS AND COUNCILORS SUGGESTIONS</caption>
                    <tr class="headings">
                        <td>Prefect's/Councilor's name</td>
                        <td>Suggestions</td>
                ...
                <tbody>
                    <?php
                    include("connect.php");
                    $query="SELECT * FROM prefectsandcouncilors";
